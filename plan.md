...
- IE32: A warning-level detector for nominalizations in a `take` or `note`, calibrated on every current entry before adoption, with a self-test fixture and a filter note.
