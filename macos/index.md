...
- iTerm2: After installation, use the saved preferences in folder `/Users/user1/<private>/etc/iTerm2/`
...
```
cd
mkdir <private>/etc/VSCodium
rsync -av Library/Application\ Support/VSCodium/ <private>/etc/VSCodium/
```
...
```
cd
rsync -av <private>/etc/VSCodium/ Library/Application\ Support/VSCodium/
```
...
```
cd
mkdir <private>/etc/KeePassXC
cp Library/Application\ Support/KeePassXC/keepassxc.ini <private>/etc/KeePassXC/
cp Library/Preferences/org.keepassxc.keepassxc.plist <private>/etc/KeePassXC/
```
...
```
cd
cp <private>/etc/KeePassXC/keepassxc.ini Library/Application\ Support/KeePassXC/
cp <private>/etc/KeePassXC/org.keepassxc.keepassxc.plist Library/Preferences/
```
